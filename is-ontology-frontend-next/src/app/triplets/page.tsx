...
export default function Page() {
    ...
    const columns = useMemo(() => ["left", "rel", "right", "doc.desc", "expert", "date"].map(v =>
    ...
    return <Box>
        <Typography variant='h1'>Список триплетов информационной безопасности</Typography>
